...
import openpipe #lamini
from openpipe import OpenPipe #lamini import Lamini
#lamini.api_key="6aeffd30d11098c222e641019dc4143882438e2801990e3e91e2d2d3ade153a9"
openpipe.api_key = "opk_90ee8c5dc89e9644a6d1e4b15ce046e7c2fcfd6193"
...
job = llm.tune(
    ...
    run_name="openpipe-qa-finetune"
          )
llm.get_job_status(job["id"])
response = llm.generate("What is Lamini?")
print(response)
