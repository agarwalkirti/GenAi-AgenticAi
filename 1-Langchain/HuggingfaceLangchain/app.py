...
## Get the hugging face API Key and url(YouTube or website)to be summarized
with st.sidebar:
    huggingface_api_key=st.text_input("HuggingFace API Key",value="",type="password")

generic_url=st.text_input("URL",label_visibility="collapsed")

## Llama Model Using hugging face API
repo_id ="google/gemma-2-9b" 
llm = HuggingFaceEndpoint(repo_id= repo_id, temperature=0.7,huggingfacehub_api_token = huggingface_api_key)
